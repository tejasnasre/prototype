...
export default function Home() {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Anyone with a passion for coding and problem-solving can participate. Whether you're a student, professional, or hobbyist, we welcome you!",
      icon: "👩‍💻",
    },
    {
      id: 3,
      ...
      answer:
        "It's happening on April 16th, 2025, at GHRCEMN venue details will be shared with registered participants.",
      icon: "📍",
    },
    {
      id: 4,
      ...
      answer:
        "Click on the 'Register Now' button on our website and fill out the registration form.",
      icon: "✍️",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      answer:
        "Nothing much folks, just bring your laptop with charger, extension board (if you got any or else we will provide you), and your creativity fs.",
      icon: "🤔",
    },
    {
      id: 8,
      ...
      answer:
        "The total prize pool is ₹10,000, along with internship opportunities and tech goodies for winners.",
      icon: "🏆",
    },
    {
      id: 9,
      ...
      answer:
        "DW folks we got you covered, we will provide you with something lighter to eat if you want to bring in your own snacks and lunchbox feel free too.",
      icon: "🍽",
    },
    {
      id: 10,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <section className="py-8 sm:py-12 md:py-16">
          <div className="flex flex-col items-center justify-center">
              ...
              <div className="bg-[#030014]/70 backdrop-blur-lg rounded-2xl overflow-hidden">
                ...
                >
                  <div className="flex flex-col items-center justify-center text-center p-2">
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#6c63ff]">
                      8
                    </h3>
                  ...
                  <div className="flex flex-col items-center justify-center text-center p-2">
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#ff6584]">
                      200+
                    </h3>
                    <p className="text-white/60 text-xs sm:text-sm">
                      Participants
                  ...
                  <div className="flex flex-col items-center justify-center text-center p-2">
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#43e97b]">
                      4+
                    </h3>
            ...
            >
              <h3 className="text-lg sm:text-xl font-medium text-white/60 mb-4 sm:mb-6">
                Our Swag Partner
              </h3>
